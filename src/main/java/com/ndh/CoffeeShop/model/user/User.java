package com.ndh.CoffeeShop.model.user;
...
import com.ndh.CoffeeShop.service.CommonService;
...
public class User extends BaseEntity {
    ...
    @JsonIgnore
    private Set<UserAuthRight> authRights = new HashSet<>();
    ...
    public void doBuildAuths(){
        ...
        if (this.authRights != null) {
            for (UserAuthRight authRightEntity : authRights) {
